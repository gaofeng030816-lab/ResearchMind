...
Read docs/ARCHITECTURE.md for the accepted 3.0.0rc1 V3 behavior and the relevant
V3 decision records for completed evidence. Future expansion requires a new named
gate. No primary V3 stage is Active. G4 is Completed: it persists explicit
