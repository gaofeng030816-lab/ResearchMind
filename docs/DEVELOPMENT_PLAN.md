...
同步日期：2026-09-01 · 状态：M0–M6、V1.1–V1.3.2 与 V2 已完成；本文为历史记录 · 配套：[PRODUCT_SPEC.md](./PRODUCT_SPEC.md) · [ARCHITECTURE.md](./ARCHITECTURE.md) · [V2→V3 当前门禁](../V2%20to%20V3过渡要求.md) · [V1→V2 历史门禁](../V1%20to%20V2过渡要求.md)
...
2026-09-04 导航更新：2.0.0rc1 已通过 V2 内部验收；V3-G0/G1 已在独立 V2→V3
规划中完成，G2 Active，附件读取门禁与人工验收待完成。M0–M6 不再承担 V3 待办或架构授权；G1 资料库
实现与证据不得回填成 V1 历史里程碑。
