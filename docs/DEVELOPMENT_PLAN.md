...
同步日期：2026-09-01 · 状态：M0–M6、V1.1–V1.3.2 与 V2 已完成；本文为历史记录 · 配套：[PRODUCT_SPEC.md](./PRODUCT_SPEC.md) · [ARCHITECTURE.md](./ARCHITECTURE.md) · [V2→V3 当前门禁](../V2%20to%20V3过渡要求.md) · V1→V2 历史门禁文件当前不在此 checkout
...
2026-09-21 导航更新：3.0.0rc1 已通过 V3 本地内部验收；V3-G0–G7 全部完成，
用户已明确确认 G7。2.0.0rc1 V2 基线继续独立保留；当前仍不对外发布。G5/G6
生产边界见各自决策记录，G7 自动与人工证据见
V3_G7_HARDENING_ACCEPTANCE.md。
M0–M6 不再承担 V3 待办或架构授权；G1 资料库
实现与证据不得回填成 V1 历史里程碑。
...
状态与最终发布门禁原由 `V1 to V2过渡要求.md` 管理；该历史文件当前不在此
checkout，已完成证据以本目录各验证记录为准。
