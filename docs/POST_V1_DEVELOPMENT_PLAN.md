...
## 下一迭代：V1.3.1 上下文质量评测与纠错

V1.3.1 是 V1.3 的内部修订，不使用 V1.4 版本号。计划范围：

- 完成 V1.3 上下文展开区的人工视觉验收；
- 选择一组有代表性的真实数字版论文，记录标题/图表说明的正确关联、漏识别和
  误关联；
- 为规则缺陷先补回归样本，再做小范围分类与关联规则修正；
- 检查长周边文本、窄窗口和中英文论文下的预览可读性；
- 不在本修订中引入 OCR、模型分类器、RAG、数据库或代码识别。
