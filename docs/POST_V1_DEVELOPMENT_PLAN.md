...
同步日期：2026-09-21（导航更新，历史证据不变）· 状态：V1.1–V1.3.2、T5-A/T5-B1 与 T6-A–T6-D 已完成；2.0.0rc1 为已验收 V2 基线；3.0.0rc1 V3-G0–G7 已完成并通过用户内部验收

> 本文保留 V1.x 优化的历史过程。T1–T6 原历史门禁文件
> `V1 to V2过渡要求.md` 当前不在此 checkout；当前 V3 阶段和门禁改由
